...
bot = telebot.TeleBot('6809927726:AAFObbvNOdcsjA64f_Fs6rwrCVaAQuEzGUo')
...
✅ Usage: /remove <userid>'''
        ...
        response = "You have not purchased yet purchase now from:- @RAHUL_DDOS 🙇."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @RAHUL_DDOS 🙇."
    bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi @RAHUL_DDOS")
...
Buy From :- @RAHUL_DDOS
Official Channel :- https://t.me/+VhA63GzxeGwxOWRl
'''
...
3. MAKE SURE YOU JOINED https://t.me/+VhA63GzxeGwxOWRl OTHERWISE NOT WORK
